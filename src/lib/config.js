...
┝ _➛${prefix}cerrargrupotemp *<tiempo>*
┝ _➛${prefix}abrirgrupotemp *<tiempo>*
...
{
return `[❗] Usa ${prefix}cerrargrupotemp <tiempo> segundos|minutos|horas|dias`
}

function abrirGrupoTempErroMensagem()
{
return `[❗] Usa ${prefix}abrirgrupotemp <tiempo> segundos|minutos|horas|dias`
}

function escolherTimerFecharGrupoMensagem()
{
return `[❗] Elija entre segundos, minutos, horas, dias\n \nejemplo : ${prefix}cerrargrupotemp 30 segundos`
}

function escolherTimerAbrirGrupoMensagem()
{
return `[❗] Elija entre segundos, minutos, horas, dias\n \nejemplo : ${prefix}abrirgrupotemp 10 segundos`
}
...
{
return `[❗] Usa ${prefix}noticias sin argumentos!`
}
...
{
return 'Enviando... si no llegar nada la cuenta es privada or el link no esta ingresado corretamente.'
}
...
{
return '[❗] La imagen/vídeo del link no fue encontrada, talvez no exista or fue ingresado incorrectamente.'
}
