...
const { WAProto, initAuthCreds, BufferJSON } = require("@whiskeysockets/baileys")
const { getDbConnection } = require("./db.js")

module.exports = async function usePostgresAuthState(sessionID, saveOnlyCreds = false) { // parametro para informar ao script para salvar apenas a key creds no DB
