...
const usePostgresAuthState = require('./src/lib/usePostgresAuthStore.js')
...
// const { state, saveCreds, removeCreds } = await useMultiFileAuthState('auth_info_baileys')
const { state, saveCreds } = await usePostgresAuthState('mclovindb', true)
