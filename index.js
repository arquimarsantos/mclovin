...
let { state, saveCreds, removeCreds } = await useMultiFileAuthState('sessions')
...
let api = await fetch(`https://api.zenext.xyz/stalker/ig?username=${encodeURI(args[0].replace(/^@/, ''))}&apikey=zenzkey_91737a4ecd09`)
...
if(isGroup) {
bot.sendPresenceUpdate('composing', from)
if (!texto || args[1]) return reply(`𝙄𝙉𝙂𝙍𝙀𝙎𝙀 𝙀𝙇 𝙐𝙎𝙐𝘼𝙍𝙄𝙊 𝘿𝙀 𝘼𝙇𝙂𝙐𝙄𝙀𝙉 𝘿𝙀 TIKTOK\n𝙀𝙅𝙀𝙈𝙋𝙇𝙊\n*${prefix + cmd} nasho.am*`)
try {
let api = await fetch(`https://api.lolhuman.xyz/api/stalktiktok/${texto}?apikey=GataDios`)
let x = await api.json()
if (api.status !== 200) throw await api.text()
if (!x.status) throw x
let thumb = await (await fetch(x.result.user_picture)).buffer()
let ttk = `
👤 𝙐𝙎𝙐𝘼𝙍𝙄𝙊(𝘼) | 𝙐𝙎𝙀𝙍
${x.result.username}
┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
...
${x.result.bio}
`.trim()
const templatettkstalkMessage = {
image: { url: thumb},
caption: ttk
}
bot.sendMessage(from, templatettkstalkMessage, { quoted: info })
} catch (e) {
reply('talvez o usuário não foi encontrado!')
}
}
break
*/
...
bot.sendMessage(from, { react: { text: randomemoji, key: info.key }})
try {
let api = await fetch(`https://api.zenext.xyz/downloader/pinterestdl?apikey=zenzkey_91737a4ecd09&url=${encodeURI(args[0])}`)
let x = await api.json()
...
reply(randomscmsg)
try {
let api = await fetch(`https://api.zenext.xyz/downloader/soundcloud?apikey=zenzkey_91737a4ecd09&url=${encodeURI(args[0])}`)
let x = await api.json()
...
try {
let apiurl = await fetch('https://api.zenext.xyz/randomanime/couples?apikey=zenzkey_91737a4ecd09')
...
try {
let apiurl = await fetch('https://api.zenext.xyz/randomanime/husbu?apikey=zenzkey_91737a4ecd09')
await bot.sendMessage(from, { image: apiurl }, { quoted: info })
} catch (e) {
reply('talvez o usuário não tenha a conta privada!')
}
...
if (texto) return reply(`𝙄𝙉𝙂𝙍𝙀𝙎𝙀 UN NOMBRE`)
try {
let apiurl = await fetch('https://api.zenext.xyz/randomanime/neko?apikey=zenzkey_91737a4ecd09')
await bot.sendMessage(from, { image: apiurl }, { quoted: info })
} catch (e) {
reply('talvez o usuário não tenha a conta privada!')
}
...
if (texto) return reply(`𝙄𝙉𝙂𝙍𝙀𝙎𝙀 UN NOMBRE`)
try {
let apiurl = await fetch('https://api.zenext.xyz/randomanime/waifu?apikey=zenzkey_91737a4ecd09')
await bot.sendMessage(from, { image: apiurl }, { quoted: info })
} catch (e) {
reply('talvez o usuário não tenha a conta privada!')
}
...
if (texto) return reply(`𝙄𝙉𝙂𝙍𝙀𝙎𝙀 UN NOMBRE`)
try {
let apiurl = await fetch('https://api.zenext.xyz/randomanime/calliope?apikey=zenzkey_91737a4ecd09')
await bot.sendMessage(from, { image: apiurl }, { quoted: info })
} catch (e) {
reply('talvez o usuário não tenha a conta privada!')
}
...
if (texto) return reply(`𝙄𝙉𝙂𝙍𝙀𝙎𝙀 UN NOMBRE`)
try {
let apiurl = await fetch('https://api.zenext.xyz/randomanime/kitagawa?apikey=zenzkey_91737a4ecd09')
await bot.sendMessage(from, { image: apiurl }, { quoted: info })
} catch (e) {
reply('talvez o usuário não tenha a conta privada!')
}
...
if (texto) return reply(`𝙄𝙉𝙂𝙍𝙀𝙎𝙀 UN NOMBRE`)
try {
let apiurl = await fetch('https://api.zenext.xyz/randomanime/maid?apikey=zenzkey_91737a4ecd09')
await bot.sendMessage(from, { image: apiurl }, { quoted: info })
} catch (e) {
reply('talvez o usuário não tenha a conta privada!')
}
...
if (texto) return reply(`𝙄𝙉𝙂𝙍𝙀𝙎𝙀 UN NOMBRE`)
try {
let apiurl = await fetch('https://api.zenext.xyz/randomanime/megumin?apikey=zenzkey_91737a4ecd09')
await bot.sendMessage(from, { image: apiurl }, { quoted: info })
} catch (e) {
reply('talvez o usuário não tenha a conta privada!')
}
...
if (texto) return reply(`𝙄𝙉𝙂𝙍𝙀𝙎𝙀 UN NOMBRE`)
try {
let apiurl = await fetch('https://api.zenext.xyz/randomanime/oppai?apikey=zenzkey_91737a4ecd09')
await bot.sendMessage(from, { image: apiurl }, { quoted: info })
} catch (e) {
reply('talvez o usuário não tenha a conta privada!')
}
...
if (texto) return reply(`𝙄𝙉𝙂𝙍𝙀𝙎𝙀 UN NOMBRE`)
try {
let apiurl = await fetch('https://api.zenext.xyz/randomanime/raiden?apikey=zenzkey_91737a4ecd09')
await bot.sendMessage(from, { image: apiurl }, { quoted: info })
} catch (e) {
reply('talvez o usuário não tenha a conta privada!')
}
...
if (texto) return reply(`𝙄𝙉𝙂𝙍𝙀𝙎𝙀 UN NOMBRE`)
try {
let apiurl = await fetch('https://api.zenext.xyz/randomanime/selfies?apikey=zenzkey_91737a4ecd09')
await bot.sendMessage(from, { image: apiurl }, { quoted: info })
} catch (e) {
reply('talvez o usuário não tenha a conta privada!')
}
...
if (texto) return reply(`𝙄𝙉𝙂𝙍𝙀𝙎𝙀 UN NOMBRE`)
try {
let apiurl = await fetch('https://api.zenext.xyz/randomanime/shinobu?apikey=zenzkey_91737a4ecd09')
await bot.sendMessage(from, { image: apiurl }, { quoted: info })
} catch (e) {
reply('talvez o usuário não tenha a conta privada!')
}
...
if (texto) return reply(`𝙄𝙉𝙂𝙍𝙀𝙎𝙀 UN NOMBRE`)
try {
let apiurl = await fetch('https://api.zenext.xyz/randomanime/uniform?apikey=zenzkey_91737a4ecd09')
await bot.sendMessage(from, { image: apiurl }, { quoted: info })
} catch (e) {
reply('talvez o usuário não tenha a conta privada!')
}
...
const res = await fetch(`https://api.zenext.xyz/ephoto/american?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/anonymous?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/aov?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/arrow?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/arrow2?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/blackpink?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/blueneon?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/buoys?text=${encodeURIComponent(args[0])}&text2=${encodeURIComponent(args[1])}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/cake?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/caper?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/cloth?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/cloud?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/coverpubg?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/crank?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/dragonfire?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/eraser?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/foggy?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/glasses?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/graffiti?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/greenbrush?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/hallowen?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/heated?text=${encodeURIComponent(args[0])}&text2=${encodeURIComponent(args[1])}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/horror?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/incandescent?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/juventus?text=${encodeURIComponent(args[0])}&number=${encodeURIComponent(args[1])}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/leafgraphy?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/letters?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/metals?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/ml?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/neonblue?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/neonbp?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/nightstars?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/pencil?text=${encodeURIComponent(args[0])}&text2=${encodeURIComponent(args[1])}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/pig?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/pubgavatar?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/puppy?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/quotestatus?text=${encodeURIComponent(args[0])}&text2=${encodeURIComponent(args[1])}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/scholes?text=${encodeURIComponent(args[0])}&number=${encodeURIComponent(args[1])}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/socialbutton?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/sunlight?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/television?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/typography?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/typography2?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/warface?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/water?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/wood?text=${encodeURIComponent(args[0])}&text2=${encodeURIComponent(args[1])}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/writestatus?text=${encodeURIComponent(args[0])}&text2=${encodeURIComponent(args[1])}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/ephoto/yasuologo?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/3dchristmas?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/crackedstone?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/3ddeepsea?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/3dgradient?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/3dneonlight?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/3drainbow?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/3dscifi?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/3dwaterpipe?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/americanflag?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/berry?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/blackpink?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/bluecircuit?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/christmas?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/dropwater?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/fiction?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/firework?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/foggywindows?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/glitch?text=${encodeURIComponent(args[0])}&text2=${encodeURIComponent(args[1])}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/gluetext?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/greenhorror?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/halloween?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/harrypotter?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/impressiveglitch?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/magma?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/marvel?text=${encodeURIComponent(args[0])}&text2=${encodeURIComponent(args[1])}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/matrix?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/metallic?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/natural?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/neondevil?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/pornhub?text=${encodeURIComponent(args[0])}&text2=${encodeURIComponent(args[1])}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/sketch?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/space?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/thunder?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/transformer?text=${encodeURIComponent(texto)}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/logowolf2?text=${encodeURIComponent(args[0])}&text2=${encodeURIComponent(args[1])}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
const randomemojismsg = rsuperemojis[Math.floor(Math.random() * rsuperemojis.length)]
bot.sendMessage(from, { react: { text: randomemojismsg, key: info.key }})
const res = await fetch(`https://api.zenext.xyz/textpro/logowolf?text=${encodeURIComponent(args[0])}&text2=${encodeURIComponent(args[1])}&apikey=zenzkey_91737a4ecd09`)
await bot.sendMessage(from, { image: res}, {quoted: info})
} catch (e) {
reply(apiErroMensagem())
}
...
bot.sendMessage(from, {text: txt, mentions: array_owners}, {quoted: orderselo})
} else if (isDono) {
let getGroups = await bot.groupFetchAllParticipating()
let groups = Object.entries(getGroups).slice(0).map(entry => entry[1])
txt = `✦ ────『 *Grupos* 』──── ⚝\n━━━━━━━━━━━━━━━━━━━━━━\n𝗧𝗼𝘁𝗮𝗹: ${groups.length}\n━━━━━\n`
